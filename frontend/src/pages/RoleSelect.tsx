...
const NON_VILLAGER_ROLES = ["Dân làng", "Sói", "Bán sói", "Sói con", "Linh sói", "Kẻ bị nguyền", "Trưởng làng", "Hộ nhân", "Tiên tri", "Bảo vệ", "Phù thủy", "Thợ săn", "Thần tình yêu"] as const;
  ...
  return (
    <div className="page-shell roleselect-page" style={{ padding: 20 }}>
      ...
      <div className="roleselect-grid">
        ...
        {(["Bán sói", "Sói con", "Linh sói", "Kẻ bị nguyền", "Trưởng làng", "Hộ nhân", "Tiên tri", "Bảo vệ", "Phù thủy", "Thợ săn", "Thần tình yêu"] as const).map((role) => {
