...
export default function Lobby() {
  ...
  return (
    <div style={{ minHeight: "100vh", padding: 24, background: "radial-gradient(circle at top, rgba(255,190,92,0.18), transparent 30%), linear-gradient(180deg, #09111f, #050813)", color: "#f4f6fb" }}>
